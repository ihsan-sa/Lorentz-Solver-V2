...
compile_fresh: ./numerical_simulation/main.cpp ./numerical_simulation/vector.cpp ./numerical_simulation/object.cpp ./numerical_simulation/space.cpp ./numerical_simulation/automation.cpp ./numerical_simulation/config.cpp
	make clean
	mkdir compiled_files
